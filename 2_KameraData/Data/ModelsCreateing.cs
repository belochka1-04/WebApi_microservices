    ...
    public class ModelsCreateing
    {
       ...
       .ToTable(tb => tb.UseSqlOutputClause(false));
          ...
          HasColumnName("date_update");
            ...
            modelBuilder.Entity<OnboardingVideo>(entity =>
            {
            ...
            modelBuilder.Entity<Issue>(entity =>
            {
                ...
                entity.Property(e => e.Mode)
                    .HasColumnName("Mode")  // Сохраняем оригинальное написание из БД
                    .HasMaxLength(50);
            ...
            modelBuilder.Entity<TipsVideo>(entity =>
            {
            ...
            // TipsLink
            modelBuilder.Entity<TipsLink>(entity =>
            {
                ...
                // Индекс для оптимизации запросов по remaining_shows
                entity.HasIndex(e => e.RemainingShows)
