...
{
    public class PartsNamesArchiveConfiguration : IEntityTypeConfiguration<PartsNamesArchive>
    {
        public void Configure(EntityTypeBuilder<PartsNamesArchive> entity)
        {
